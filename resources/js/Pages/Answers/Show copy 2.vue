...
export default {
    ...
    mounted() {
        // Votre logique pour récupérer les données du formulaire
        // Assurez-vous de remplir formQuestions avec les questions récupérées
    },
    methods: {
        sendForm() {
            // Votre logique pour envoyer le formulaire
        },
    },
};
</script>
